...
sys.path.append(codepath+'/../lib')            # for debugging

sys.path.append(codepath+'/lib')               # for production: location of read_all.o as seen by train.py 
...
class dfeat_raw:
    ...
    def load(self):
        ...
        """ 
            ...
            The sparse array for the whole MOVEMENT file is loaded.  rsu
        ...
        for feature in self.use_Ftype:
            ...
            print ("dfeat binary dir:", dfeatdirs[feature])
            print ("itype_atom", itype_atom)
            print ("self.nfeat", self.nfeat) 
            """
