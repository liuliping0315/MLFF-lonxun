PROGRAM gen_2bgauss_feature
    ...
    integer n3b1_type(100),n3b2_type(100)
...
!cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
    ...
    open(10,file="input/gen_2bgauss_feature.in",status="old",action="read")
    rewind(10)
    ...
    enddo
    close(13)
    trainDataDir=trim(trainSetDir)//"/trainData.txt.Ftype3"
    inquirepos1=trim(trainSetDir)//"/inquirepos3.txt"
...
!cccccccccccccccccccccccccccccccccccccccccccccccccccc
    ...
    do 2333 sys=1,sys_num
        ...
        dfeatDir=trim(trainSetFileDir(sys))//"/dfeat.fbin.Ftype3"
        infoDir=trim(trainSetFileDir(sys))//"/info.txt.Ftype3"
...
! This num_neigh_alltype(iat) include itself !
    dfeat=0.d0
    feat=0.d0
    call find_feature_2bgauss(natom,itype_atom,Rc_type,n2b_type,num_neigh,  &
       list_neigh,dR_neigh,iat_neigh,ntype,grid2,wgauss, &
